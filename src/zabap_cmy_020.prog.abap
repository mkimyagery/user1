...
DATA : gt_date_info TYPE TABLE OF zcm_date_info3,
       gs_date_info TYPE          zcm_date_info3,
...
*SELECT * FROM zcm_date_info3 INTO TABLE gt_date_info.
*
*gs_date_info-id       = lines( gt_date_info ) + 1.
  ...
  INSERT zcm_date_info3 FROM gs_date_info.
  CLEAR : gs_date_info.
